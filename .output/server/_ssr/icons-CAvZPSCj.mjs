...
*/
function renderCmsIcon(iconName, props = {}) {
	if (!iconName) return import_react.createElement(Sparkles, props);
	const IconComponent = lucide_react_exports[iconName];
	if (IconComponent && typeof IconComponent === "function") return import_react.createElement(IconComponent, props);
	return import_react.createElement(Sparkles, props);
}
//#endregion
export { ICON_CATEGORIES as n, renderCmsIcon as r, CMS_ICON_CATALOG as t };
