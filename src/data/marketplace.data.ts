export const TEMU_CIRCLE_CATEGORIES = [
  {
    id: "all",
    name: "All Drops",
...
export const FLASH_PROMO_SLIDES = [
  {
    id: "promo_1",
...
export const GENERAL_FAQS = [
  {
    q: "How does the Payroxa Escrow Guarantee protect my cash?",
    a: "When you pay for a Temu-style drop, the cash goes into an independent multi-signature safe vault. The merchant only receives the funds when you physically receive, inspect, and approve the cargo. If the seller doesn't ship or files broken tracking, your money is returned directly to your ledger.",
  },
  {
    q: "Is shipping really free across all countries?",
    a: "Yes! In collaboration with regional air cargo carriers and DHL, Payroxa offers free cargo dispatch for orders exceeding minimum tier amounts, covered directly by merchant ledger commissions.",
  },
  {
    q: "What local payment options can I use to pay?",
    a: "You can pay instantly with Nigerian Naira (NGN), Ghanaian Cedis (GHS), Kenyan Shillings (KES), South African Rand (ZAR), US Dollars (USD), Mobile Money (MTN MoMo, Telecel, M-Pesa), bank transfers, or USDC/USDT stablecoins.",
  },
];
