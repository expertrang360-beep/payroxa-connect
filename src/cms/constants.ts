...
export const INITIAL_CMS_DATABASE: CmsDatabaseState = {
  ...
  seo: {
    ...
    marketplace: {
      ...
      metaTitle: "Payroxa Marketplace — Buy From Verified African Businesses",
      metaDescription:
        "Shop verified vendors on the Payroxa Marketplace, with secure checkout, wallet payments and reliable delivery across Nigeria.",
      keywords: "online marketplace Nigeria, buy from verified vendors, Payroxa marketplace",
      canonicalUrl: `${siteConfig.websiteUrl}/marketplace`,
      ogTitle: "Payroxa Marketplace — Buy From Verified African Businesses",
      ogDescription:
        "Shop verified vendors on the Payroxa Marketplace, with secure checkout, wallet payments and reliable delivery across Nigeria.",
      ogImageUrl: "/hero-payroxa.jpg",
      twitterCard: "summary_large_image",
    ...
    security: {
      ...
      metaTitle: "Payroxa Security & Compliance — How We Protect Your Money",
      metaDescription:
        "Encryption, fraud monitoring, licensed partner banks and compliance controls that keep Payroxa balances and business data safe.",
      keywords: "fintech security Nigeria, PCI DSS, payment compliance Africa",
      canonicalUrl: `${siteConfig.websiteUrl}/security`,
      ogTitle: "Payroxa Security & Compliance — How We Protect Your Money",
      ogDescription:
        "Encryption, fraud monitoring, licensed partner banks and compliance controls that keep Payroxa balances and business data safe.",
      ogImageUrl: "/hero-payroxa.jpg",
      twitterCard: "summary_large_image",
    ...
    privacy: {
      ...
      metaTitle: "Payroxa Privacy Policy — How We Handle Your Data",
      metaDescription:
        "Read how Payroxa collects, stores, protects and shares personal and business information across its payment and commerce services.",
      keywords: "Payroxa privacy policy, data protection NDPR",
      canonicalUrl: `${siteConfig.websiteUrl}/privacy`,
      ogTitle: "Payroxa Privacy Policy — How We Handle Your Data",
      ogDescription:
        "Read how Payroxa collects, stores, protects and shares personal and business information across its payment and commerce services.",
      ogImageUrl: "/hero-payroxa.jpg",
      twitterCard: "summary_large_image",
    ...
    terms: {
      ...
      metaTitle: "Payroxa Terms of Service — Your Agreement With Payroxa",
      metaDescription:
        "The terms that govern the use of Payroxa wallets, payments, cards, storefronts and marketplace services.",
      keywords: "Payroxa terms of service, fintech terms Nigeria",
      canonicalUrl: `${siteConfig.websiteUrl}/terms`,
      ogTitle: "Payroxa Terms of Service — Your Agreement With Payroxa",
      ogDescription:
        "The terms that govern the use of Payroxa wallets, payments, cards, storefronts and marketplace services.",
      ogImageUrl: "/hero-payroxa.jpg",
      twitterCard: "summary_large_image",
